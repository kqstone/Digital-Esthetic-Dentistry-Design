...
public class BorderRect extends Rect2D.Float {
	...
	public int getPointFlag(Point2D point) {
		...
		Rect2D nbR = new Rect2D.Float(new Point2D.Float((float) (getX1() + getX2()) / 2, (float) getY1()), getWidth() - border,
				border);
		Rect2D sbR = new Rect2D.Float(new Point2D.Float((float) (getX1() + getX2()) / 2, (float) getY2()), getWidth() - border,
				border);
